...
class _AppHeader extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      prevProps.location.pathname.split('/')[1] !==
  ...
  handleChange = (ev) => {
    ...
    if (this.props.location.pathname === '/mail')
      eventBusService.emit('search-mail', value);
    ...
    return (
      <React.Fragment>
        ...
        <div
          ...
          className={`screen-modal ${activeModal}`}
        ></div>
        <nav className={`main-nav ${activeModal}`}>
          <NavLink
            ...
            to="/"
          >
            <img src="imgs/app/nav/homepage.png" />
            <span>Home</span>
          </NavLink>
          {/* <NavLink to="/about">About</NavLink> */}
          <NavLink onClick={this.closeModal} to="/notes">
            <img src="imgs/app/nav/google-keep.png" />
            <span>Notes</span>
          </NavLink>
          <NavLink onClick={this.closeModal} to="/mail">
            <img src="imgs/app/nav/gmail.png" />
            <span>Mail</span>
          </NavLink>
          <NavLink onClick={this.closeModal} to="/book">
